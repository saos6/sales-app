...
const form = useForm({
    ...
    cust_id: props.payment.cust_id,
    emps_id: props.payment.emps_id,
    remarks: props.payment.remarks,
    details: props.payment.details.map((d: any) => ({ payment_category: d.payment_category, bank_info: d.bank_info, amount: d.amount })),
});
    ...
    <AppLayout>
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        <CardTitle>入金情報を編集します</CardTitle>
                    </CardHeader>
                    <CardContent>
