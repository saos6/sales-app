...
const form = useForm({
    sales_no: props.sale.sales_no,
    sales_date: props.sale.sales_date,
    posting_date: props.sale.posting_date,
    cust_id: props.sale.cust_id,
    emps_id: props.sale.emps_id,
    subject: props.sale.subject,
    details: props.sale.details.map((d: any) => ({ ...d, item_id: props.items.find(i => i.item_code === d.item_code)?.id })),
});
    ...
    <AppLayout>
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        <CardTitle>売上情報を編集します</CardTitle>
                    </CardHeader>
                    <CardContent>
